...
//FIRE TEST SUITE
  describe('fire', function() {
      ...
      //Should not record damage if there are no coordinates    
      it('should NOT record damage if there is no ship at a given coordinates', function() {
          let player = {
              ships: [
                  { locations: [[0, 0]], damage: [] }
                  ]
                ...
                (player.ships[0].damage).should.be.empty;
          });
  });
});
//small addition